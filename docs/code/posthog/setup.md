...
3. Setup [Stripe test environment](stripe/README.md#setup) and setup [Supabase local development](supabase/local-development/pull-changes.md)
4. Run a local version and simulate the following events
   ...
   3. `user starts checkout` -> Craft your [checkout url](stripe/README.md#updating-your-pricing-page) (e.g. `localhost:XXXXX/payments?price=price_XXXXX)` which will create a checkout sesssion but in localhost.
